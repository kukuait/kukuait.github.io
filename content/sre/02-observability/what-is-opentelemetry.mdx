...
- [OTel 在 GKE + GCP 上，Traces / Logs / Metrics 是怎麼串起來的？](#/sre/02-observability/otel-gcp-gke-case-study.mdx)
- [OpenTelemetry 的 Metrics API 與其他 API 總覽（以 FastAPI 為例）](#/sre/02-observability/otel-metrics-api-fastapi.mdx)
