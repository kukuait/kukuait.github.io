...
這篇是 [OpenTelemetry 的功能是什麼？](#/sre/02-observability/what-is-opentelemetry.mdx) 的實務案例延伸——概念篇講的是教材上「三支柱統一 pipeline」的理想模型，這篇記錄一個真實 GKE + GCP 生產系統裡，理想模型與實際落地之間的落差。
...
- [OpenTelemetry 的功能是什麼？](#/sre/02-observability/what-is-opentelemetry.mdx)
- [GKE 上 Pod 只設 memory request 沒設 limit，實際上能用到多少 memory?](#/sre/03-operations/gke-pod-memory-without-limit.mdx)
