...
- [OpenTelemetry 的功能與應用](#/sre/02-observability/what-is-opentelemetry.mdx)——gRPC interceptor 整合 OTel 做 distributed tracing
- [GCP VPC Network 的架構與核心概念](#/sre/03-operations/gcp-vpc-network.mdx)——gRPC 服務在 VPC 內的網路設計
